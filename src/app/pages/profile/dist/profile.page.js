...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(_storage, router, formBuilder, renderer) {
        ...
        this.profileForm = formBuilder.group({
            ...
            propiedad: ['', forms_1.Validators.required]
        });
    }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a.user = _c.sent();
                        _b = this;
                        return [4 /*yield*/, this._storage.getLocalStorage('dataUser')];
                    case 2:
                        _b.dataUser = _c.sent();
    ...
    ProfilePage.prototype.myBackButton = function () {
        this.router.navigate(['/inicio']);
    };
    __decorate([
        core_1.ViewChild('drawer', { read: core_1.ElementRef, static: true })
    ], ProfilePage.prototype, "drawer");
